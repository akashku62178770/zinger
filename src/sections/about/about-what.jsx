      ...
      <Grid container columnSpacing={{ md: 3 }} alignItems="flex-start">
        ...
        <Grid xs={12} md={6} lg={5}>
          ...
          <m.div variants={varFade().inRight}>
            ...
            >
              ZingerMeal, launching in 2024, is a your go to platform for your family meals and 
            </Typography>
          </m.div>
          ...
          <m.div variants={varFade().inRight}>
            ...
            >
             Our mission is to transform the way people think about and enjoy food. We believe in providing 
             our customers with an exceptional dining experience by offering:
             <ol className=''>
              <li className=''><b>Speedy Delivery</b></li>
              <li className=''><b>Exceptional Service</b></li>
              <li className=''><b>Variety</b></li>
             </ol>
            </Typography>
          </m.div>
